...
<head>
    ...
    <title>Kelompok 1 | Dashboard</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-md-flex">
                                    <div>
                                        ...
                                        <h5 class="card-subtitle">Di Website Pencarian Rumus Volume dan Luas Bangun Ruang</h5>
                                    </div>
                                </div>
                                <!-- title -->
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p>1 Pengguna dapat mencari beberapa rumus bangun ruang yang telah disediakan</p>
                                            <p>2 Pengguna hanya menginputkan beberapa angka yang ada di dalam form</p>
                                            <p>3 Setelah pengguna memilih tombol hitung, maka hasil volume atau luas bangun ruang akan tampil</p>
                                        </div>
                                        <div class="col-md-6">
